...
<nav class="navbar navbar-fixed-top" style="background-color:white; margin-right:20px;">
   ...
   <ul class="nav navbar-nav navbar-right">
	  ...
	  <li class="active"><a href="gs_result.php">GS Result</a></li>
	</ul>
	</div>
...
<div class="row" style="margin-top:80px;">
	...
	<div class="col-md-4">
		...
		<form action="gs_vote_login.php" method="POST">
  ...
  <?php         
        ...
        {       
			...
			$sql1 = "SELECT * FROM gs_details WHERE can_name ='$username' AND can_name ='$password'";
			...
			if (mysqli_num_rows($result) === 1) {
				...
				$row = mysqli_fetch_assoc($result);
					...
					if ($row['can_name'] === $username && $row['can_name'] === $password) 
					{

							//echo "<script type='text/javascript'> document.location ='gs_voting.php?course=$stud_course&&sem=$stud_sem'; </script>";
							
							echo "<script type='text/javascript'> document.location ='gs_voting.php'; </script>";
