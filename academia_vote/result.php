...
<nav class="navbar navbar-fixed-top" style="background-color:white; margin-right:20px;">
    ...
    <ul class="nav navbar-nav navbar-right">
	  ...
	  <li class="active"><a href="result.php">Result</a></li>
	   <li class="active">
	   <a class="btn btn-primary" href="gs/gs_vote_login.php" role="button" style="margin-right:20px; margin-top:10px; width:80px; height:30px; padding:5px;" style="text-decoration:none; color:white;">GS Vote</a>
	   </li>
	...
	<center>
		<?php   
				$query = "SELECT * FROM candidate_details WHERE can_status = 'show' ORDER BY can_vote DESC";
