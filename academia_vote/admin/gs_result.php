...
<head>
	...
	<body>
		...
		<div class="sidenav">			
			...
			<a href="result_gs.php">Result(GS)</a>
		...
		<div class="main">
		  <h2 style="background-color:silver; padding:10px; text-align:center; margin-top:10px;">Admin Panel - Result Update</h2>
			...
			<form action="gs_result.php" method="POST"> 
			<?php   
				$query = "SELECT * FROM gs_details";
				$result = mysqli_query($connect, $query);  				
				$row = mysqli_fetch_array($result) 
			?>
				<input type="submit" value="<?php echo $row['status']; ?>" name="btn_status" class="btn btn-danger btn-md"/>
				...
				<?php         
					...
					{       
							...
							{
								$sql1 = "UPDATE gs_details SET status = 'show'";
							...
							$sql2 = "UPDATE gs_details SET status = 'hide'";
			...
			<?php   
				$query = "SELECT * FROM gs_details ORDER BY can_vote DESC";
				$result = mysqli_query($connect, $query);  
			?>
