...
<head>
	...
	<body>
		...
		<div class="main">
		  <h2 style="background-color:silver; padding:10px; text-align:center; margin-top:10px;">Admin Panel - Students Update</h2>
		  
		  <div class="row">
			<div class="col-md-12">
				 <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal_add_can" style="margin:10px; width:150px;">Add Student</button>
			</div>
		  </div>
    ...
    <div class="modal-dialog">
      ...
      <form>
        ...
        <div class="input-group" style="margin:10px;">
          ...
          <input id="stud_name" type="text" class="form-control" name="stud_name" placeholder="Student Name">
        </div>
		
		<div class="input-group" style="margin:10px;">
          <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
          <input id="stud_email" type="text" class="form-control" name="stud_email" placeholder="Student Email">
        </div>
		
		<div class="input-group" style="margin:10px;">
          <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
          <input id="stud_regno" type="text" class="form-control" name="stud_regno" placeholder="Student Register No">
        </div>
		
		 <div class="input-group" style="margin:10px;">
          <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
        
			<select id="stud_course" name="stud_course" style="width:full-width;" class="form-control">
		 ...
		 <div class="input-group" style="margin:10px;">
          <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
          <select id="stud_sem" name="stud_sem" style="width:full-width;" class="form-control">
	...
	<?php         
        ...
        {      
           ...
           */
            ...
            $sql = "INSERT INTO student_details(stud_name, stud_email, stud_regno, stud_course, stud_sem, stud_vote_status) VALUES ('$stud_name','$stud_email', '$stud_regno', '$stud_course', '$stud_sem', '0')";

            if(mysqli_query($connect,$sql))
            {
              //echo "<p align='center' > <font color='green'> Record Saved Sucesfully </font> </p>"; 
				echo '<script> alert("Student Added Succeesfully") </script>';
            }
            else
            {
              //echo "<p align='center' > <font color='Red'> Record Saved Failed</font> </p>";
				echo '<script> alert("Student Added Failed") </script>';
            }
        }
	?> 
	<!-- End of Btn Save -->
			...
			<?php   
				$query = "SELECT * FROM student_details ORDER BY stud_id ASC";
			...
			<div class="container">
				<div class="table-responsive">
					<table class="table table-hover table-condensed" style="width:90%;">
						...
						<tbody>
						  <tr>
							<input type="hidden" name="s_id" value="<?php echo $row['stud_id']; ?>"/>
							...
							<td> 
								...
								<a class="btn btn-danger btn-sm" href="students_del.php?del=<?php echo $row['stud_id']; ?>">  Delete </a> </td>
