...
<form class="form-horizontal" action="candidates.php" method="POST" enctype="multipart/form-data">
 <!-- Modal Sign Up -->
						...
						<tbody>
						  <tr>
							...
							<td> 
								...
								<a class="btn btn-danger btn-sm" href="candidates_del.php?del=<?php echo $row['can_id']; ?>">  Delete </a> </td>
